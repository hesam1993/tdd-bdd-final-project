...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_a_product_fails(self):
        """It should fail while Updating a Product"""
        product = ProductFactory()
        product.id = None
        product.create()
        self.assertIsNotNone(product.id)
    ...
    def test_fail_deserialize_a_product(self):
    ...
    def test_deserialize_invalid_category(self):
        ...
        data = {
            ...
            "price": "499.99",
            "available": True,
            "category": "INVALID_CATEGORY"  # This will raise AttributeError
        }
        with self.assertRaises(DataValidationError) as context:
            product.deserialize(data)
